...
The feature image shown in this article was generated by Stable Diffusion. I've always liked to envision the functional blocks of computer chips as being buildings. At a more macro-scale (virtually all modern-day processors are fabricated on process nodes with feature sizes in the nanometer scale!), it reminds me of my roots: I first got fascinated by technology after taking apart many electronic toys and marveling at the PCBs, imagining the copper traces as roads and the various resistors, capacitors, and ICs as buildings.

Below is a snapshot of computer dies on a silicon wafer chip. The process on how sand becomes a computer chip is super fascinating, and may in fact become a separate post in the future.
